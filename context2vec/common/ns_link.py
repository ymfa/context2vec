...
import context2vec.common.ns_function as negative_sampling  # from chainer.functions.loss import ...
...
class NegativeSampling(link.Link):
    ...
    """Modified negative sampling loss layer.
    ...
    def __init__(self, in_size, counts, sample_size, power=0.75, distractors=None):
        ...
        self.distractors = distractors  # target word index => list of distractors' indices
    ...
    def __call__(self, x, t, reduce='sum'):
        ...
        return negative_sampling.negative_sampling(
            ...
            reduce=reduce, distractors=self.distractors)
