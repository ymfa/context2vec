...
class NegativeSamplingFunction(function_node.FunctionNode):
    ...
    def __init__(self, sampler, sample_size, reduce='sum', distractors=None):
...
def negative_sampling(x, t, W, sampler, sample_size, reduce='sum', distractors=None):
    ...
    """
    return (
        NegativeSamplingFunction(sampler, sample_size, reduce, distractors)
        .apply((x, t, W))
    )[0]
